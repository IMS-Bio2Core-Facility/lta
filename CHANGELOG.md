...
## v3.5.0 (2025-01-09)
### Feature
* **cpa (alpha version):** Provide cluster pattern analysis module ([`b46a9a7`](https://github.com/IMS-Bio2Core-Facility/lta/commit/b46a9a772b9b9b1ad34608dc615c454dfda72450))
* **cli:** Export combined lipid class output `switch_lipid_classes_with_stats.csv` and `switch_lipid_classes.csv` ([`f9d7e6b`](https://github.com/IMS-Bio2Core-Facility/lta/commit/f9d7e6b7f2548a2afbe2ab2a894fc88134c3935d))
### Breaking
* Upgraded 3rd party libraries of the package, and ended support for Python 3.8 due to incompatibility with new packages.
* The original **lipid** and **jaccard** will not be generated by default. To generate these files, the parameter `--savealignfiles` is required.
